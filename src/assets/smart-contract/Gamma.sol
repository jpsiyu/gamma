...
contract Gamma is Base {    
    ...
    {
        _result =  keccak256(abi.encodePacked(this, _tokenGet, _amountGet, _tokenGive, _amountGive, _expires, _clientNonce));
    }
   
    function sell(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce) external {
    ...
    function buy1(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce, address _seller, uint _amount)
        external 
    {
        bytes32 sellHash = getSellHash(_tokenGet, _amountGet, _tokenGive, _amountGive, _expires, _clientNonce);
    ...
    function amountFilled(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce, address _seller) 
    ...
    function cancelOrder1(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce) external 
    {
        bytes32 sellHash = getSellHash(_tokenGet, _amountGet, _tokenGive, _amountGive, _expires, _clientNonce);
    ...
    function cancelOrder2(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce,
    ...
    function cancelOrder3(address _tokenGet, uint _amountGet, address _tokenGive, uint _amountGive, uint _expires, string calldata _clientNonce,
